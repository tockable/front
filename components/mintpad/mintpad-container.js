      ...
      {project && (
        ...
        >
          ...
          <div className="rounded-2xl p-4 mt-8 bg-tock-semiblack">
            ...
            {isError && (
              <div className="p-4">
                <p className="text-tock-red p-2 border rounded-xl mt-8 border-tock-red text-center text-xs">
                  cannot fetch data form blockchain at this moment. if problem
                  persists after refreshin the page, please try again in a
                  couple of minutes.
                </p>
              </div>
            )}
            ...
            {data && !isError && (
              <div>
                {!notStarted && !mintEnded && (!paused || data[0]?.result) && (
                  <div>
                    {!isConnected && (
                                  ...
                                  <div className="w-full mt-8">
                                    ...
                                    {parseInt(data[2].result) == 0 && (
                                      <p className="mt-8 text-tock-orange text-center p-2 border rounded-xl border-zinc-400">
                                        current active session reaches its total
